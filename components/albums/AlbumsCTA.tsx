...
export default function AlbumsCTA({ locale }: AlbumsCTAProps) {
  ...
  return (
    <section ref={ref} className="relative py-20 lg:py-32">
      <div className="container-custom">
        ...
        >
          {/* Animated border glow - magenta to purple theme */}
          <motion.div
            className="absolute -inset-1 rounded-3xl opacity-50"
            style={{
              background:
                'linear-gradient(90deg, #FF006E, #8B5CF6, #00F0FF, #FF006E)',
          ...
          >
            ...
            <div className="absolute inset-0">
              {/* Gradient mesh - magenta/purple themed */}
              <div
                className="absolute inset-0 opacity-30"
                style={{
                  background:
                    'radial-gradient(ellipse at 20% 50%, rgba(255, 0, 110, 0.2), transparent 50%), radial-gradient(ellipse at 80% 50%, rgba(139, 92, 246, 0.2), transparent 50%)',
                }}
              />
              ...
              {[...Array(5)].map((_, i) => (
                ...
                >
                  <Music2 className="w-4 h-4 text-neon-magenta/40" />
                </motion.div>
              ))}
            </div>
            ...
            <div className="relative px-8 py-16 md:px-16 md:py-20 text-center">
              {/* Icon */}
              <motion.div
                className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-neon-magenta/20 to-neon-purple/20 mb-8"
                animate={{
                  boxShadow: [
              ...
              >
                <Headphones className="w-8 h-8 text-neon-magenta" />
              </motion.div>
              ...
              <motion.h2
                className={cn(
                  ...
                  'bg-gradient-to-r from-white via-neon-magenta to-white bg-clip-text text-transparent'
                )}
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                >
                  <div className="absolute top-0 left-1/2 w-2 h-2 rounded-full bg-neon-magenta -translate-x-1/2 -translate-y-1/2" />
                </motion.div>
