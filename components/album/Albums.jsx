            ...
            {/* <img src={singleData?.img} alt="" /> */}
              ...
              <div className="main_content ">
                ...
                <div className="news_share">
                  <span><a href="ttps://www.youtube.com/@LoicGhanem/videos" target="_blank" rel="noopener noreferrer" style={{ color: "lightgreen", textDecoration: "none" }}>Listen to this album here</a></span>
                </div>
                {/* END NEWS SHARE */}
              </div>
            </div>
