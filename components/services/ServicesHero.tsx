      ...
      <div className="container-custom">
        <div className="lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="relative rounded-2xl lg:rounded-none overflow-hidden bg-obsidian-900/60 lg:bg-transparent backdrop-blur-sm lg:backdrop-blur-none border border-neon-cyan/20 lg:border-transparent">
              ...
              <div className="relative p-5 lg:p-0">
                ...
                >
                  ...
                  <span className="text-neon-cyan text-xs sm:text-sm font-medium uppercase tracking-wider">{t("hero.badge")}</span>
                </motion.div>
                ...
                >
                  <StatBadge value={servicesCount} label={t("stats.services")} icon={<Layers className="w-4 h-4 sm:w-5 sm:h-5" />} delay={0.5} />
                  <StatBadge value="15+" label={t("stats.experience")} icon={<Award className="w-4 h-4 sm:w-5 sm:h-5" />} delay={0.6} />
                  <StatBadge value="100%" label={t("stats.satisfaction")} icon={<Sparkles className="w-4 h-4 sm:w-5 sm:h-5" />} delay={0.7} />
                </motion.div>
                ...
                >
                  <MagneticButton href="#services-grid" color="lime" variant="solid" size="md" glow rightIcon={ArrowRight}>
                    {t("hero.cta")}
                  </MagneticButton>

                  <MagneticButton href={`/${locale}/contact`} color="cyan" variant="outline" size="md" rightIcon={Mail}>
                    {t("hero.ctaSecondary")}
                  </MagneticButton>
                </motion.div>
              </div>
