...
import { Calendar, Disc, Users, ArrowLeft, ArrowRight, Eye, Headphones, ExternalLink, Music, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            >
              ...
              >
                <div className="text-center space-y-6">
                  ...
                  <p className="font-mono text-sm text-neo-text/70">
                    {t('listenDescription')}
                  </p>
                  <a
                    href={album.listenLink}
