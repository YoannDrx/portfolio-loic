...
export const LanguageSwitcher = ({
  ...
  return (
    <div className={cn("flex border-2 border-neo-border", className)}>
      <button
        onClick={() => switchLocale('fr')}
        className={cn(
          "px-3 py-1.5 font-mono text-xs font-bold transition-colors duration-150",
          locale === 'fr'
      ...
      <button
        ...
        className={cn(
          "px-3 py-1.5 font-mono text-xs font-bold transition-colors duration-150 border-l-2 border-neo-border",
          locale === 'en'
            ? "bg-neo-accent text-neo-text-inverse"
            : "bg-neo-surface text-neo-text hover:bg-neo-surface-hover"
        )}
