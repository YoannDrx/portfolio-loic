  ...
  return (
    <section id="soundcloud" className="py-32">
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex justify-between items-end mb-16 border-b border-[var(--glass-border)] pb-4"
      >
        <div>
          <h2
          ...
          />
          <span className="text-muted-foreground font-mono text-sm md:text-base">{t('subtitle')}</span>
        </div>
