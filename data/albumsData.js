            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        The album was released under the label <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
        ),
            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        the label Montmorency <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
        ),
            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        album is signed under my artist name, Voyager1, and is also intended for publishing. The album was released under the label Justement Music and the publisher{" "}
    ...
    },
    {
        ...
        descriptions: (
            <>
                <div className="descriptions">
                    <p className="bigger">
                        "Cyberpunk" is an immersive blend of futuristic, cinematic electronic music, reminiscent of Blade Runner, released in April 2020. This project, whilst primarily a publishing
                        album, bears a deeply personal touch, making it stand out as a potential soundtrack for video games. The album was released under the label{" "}
            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        album was released under the label <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
        ),
            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        label Stereoscopic and published by <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
        ),
    },
    {
        ...
        descriptions: (
            <>
                <div className="descriptions">
                    <p className="bigger">
                        "Synthwave" is a nostalgic blend of '80s revival electro, released in October 2019. This album is an homage to the Synthwave genre, reflecting its iconic style. The album was
                        produced for publishing and released under the label <span className="collab-name">Stereoscopic</span> and published by{" "}
                        <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
            ...
            <>
                <div className="descriptions">
                    <p className="bigger">
                        ...
                        <span className="collab-name">Aaron Matts</span>. This album was part of the label Justement and published by{" "}
                        <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
    ...
    },
    {
        ...
        descriptions: (
            <>
                <div className="descriptions">
                    <p className="bigger">
                        "Death Metal" is a potent blend of death metal and deathcore, released in March 2019. This album features collaborations with <span className="collab-name">Terence</span> and{" "}
                        <span className="collab-name">Aaron</span> on several tracks. Signed under my artist name, this album was produced for publishing and released under the label{" "}
                        <span className="collab-name">Justement</span> and the publisher <a href="https://myma-music.com/">Montmorency Music Agency, MYMA</a>.
                    </p>
                </div>
            </>
        ),
